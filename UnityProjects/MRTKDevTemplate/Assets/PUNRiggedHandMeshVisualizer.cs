...
namespace MixedReality.Toolkit.Input
{
    ...
    public class PUNRiggedHandMeshVisualizer : MonoBehaviour
    {
        ...
        protected void OnEnable()
        {
            ...
            if (view.IsMine) {
                this.view.RPC("UpdateRendererState", RpcTarget.OthersBuffered, handRenderer.enabled);
            }
        ...
        private void Update()
        {
            ...
            if (view.IsMine)
            {
                ...
                // Stream the data out
                this.view.RPC("UpdateHandScale", RpcTarget.OthersBuffered, transform.localScale);
